package br.gov.df.economia.sistemaauditoriahiveoracle.model.dao.impl;
...
import br.gov.df.economia.sistemaauditoriahiveoracle.model.dao.AgendaDao;
...
public class AgendaDaoJDBC implements AgendaDao {
	...
	public List<Agenda> findAll() {
	    ...
	    try {
	        st = conn.prepareStatement(
	                "SELECT * FROM ADMDEC.DEC_AGENDA_EXTRACAO WHERE par_inicio >= ? ORDER BY COD_AGENDA_EXTRACAO");
	...
	public List<Agenda> findAllByTipoDoc(TipoDoc tipoDoc, int dias) {
	    ...
	    try {
	        st = conn.prepareStatement(
	                "SELECT * FROM ADMDEC.DEC_AGENDA_EXTRACAO WHERE TIPO_DOC = ? AND par_inicio >= ? ORDER BY COD_AGENDA_EXTRACAO");
