...
import br.gov.df.economia.sistemaauditoriahiveoracle.model.entities.PendenciasHive;
import br.gov.df.economia.sistemaauditoriahiveoracle.db.HiveDecDatabaseOperations;
import br.gov.df.economia.sistemaauditoriahiveoracle.gui.util.ComboBoxUtil;
import br.gov.df.economia.sistemaauditoriahiveoracle.model.entities.DuplicidadeId;
import br.gov.df.economia.sistemaauditoriahiveoracle.model.entities.OracleHive;
...
public class PendenciasHiveController {
    ...
    private void loadDuplicidadeIdData(String fileName) {
        try (BufferedReader br = new BufferedReader(new FileReader(Configuracao.DIRECTORY_PATH_PENDENCIA_HIVE + fileName))) {
            String line;
