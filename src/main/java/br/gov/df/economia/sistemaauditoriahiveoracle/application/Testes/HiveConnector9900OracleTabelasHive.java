...
public class HiveConnector9900OracleTabelasHive {
    ...
    public void executeQueryWithJoin(String filePath) throws SQLException, IOException {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(Configuracao.DIRECTORY_PATH_PENDENCIA_SPED + "ResultadoQuery.csv"))) {
    ...
    public static void main(String[] args) {
        ...
        try {
            connector.executeQueryWithJoin(Configuracao.DIRECTORY_PATH_PENDENCIA_SPED  + "RACLE_SPED_9900.csv");
        } catch (Exception e) {
