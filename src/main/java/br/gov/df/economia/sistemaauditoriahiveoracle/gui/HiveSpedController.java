...
import br.gov.df.economia.sistemaauditoriahiveoracle.model.entities.Sped9900;
import br.gov.df.economia.sistemaauditoriahiveoracle.Validacoes.TabelasSped;
...
import br.gov.df.economia.sistemaauditoriahiveoracle.model.entities.Hive9900TabelasHive;
import br.gov.df.economia.sistemaauditoriahiveoracle.model.entities.Hive9900TabelasHiveFaltantes;
...
public class HiveSpedController {
    ...
    private void loadCSVData() {
        List<Sped9900> dataList = CSVUtils.loadSped9900FromCsv(Configuracao.DIRECTORY_PATH_PENDENCIA_SPED + "Pendencia_Processamento_0000.csv");
    ...
    private void loadCSVDataHive9900TabelasHive() {
        List<Hive9900TabelasHive> dataList = CSVUtils.loadHive9900TabelasHiveFromCsv(Configuracao.DIRECTORY_PATH_PENDENCIA_SPED + "divergencia9900TabelasSped.csv");
    ...
    private void loadCSVDataHive9900TabelasHiveFaltante() {
        List<Hive9900TabelasHiveFaltantes> dataList = CSVUtils.loadHive9900TabelasHiveFromCsvFaltantes(Configuracao.DIRECTORY_PATH_PENDENCIA_SPED + "ResultadoQuery.csv");
    ...
    public HiveSpedController() {
        ...
        this.filePath = Configuracao.DIRECTORY_PATH_PENDENCIA_SPED + "HIVE_SPED_9900.csv";
    }
