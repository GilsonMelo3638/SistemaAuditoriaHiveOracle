package br.gov.df.economia.sistemaauditoriahiveoracle.gui;

import br.gov.df.economia.sistemaauditoriahiveoracle.application.Main;
import br.gov.df.economia.sistemaauditoriahiveoracle.Validacoes.TipoDoc;
import br.gov.df.economia.sistemaauditoriahiveoracle.db.*;
import br.gov.df.economia.sistemaauditoriahiveoracle.gui.util.Alerts;
...
import br.gov.df.economia.sistemaauditoriahiveoracle.gui.util.Utils;
import br.gov.df.economia.sistemaauditoriahiveoracle.model.entities.Agenda;
import br.gov.df.economia.sistemaauditoriahiveoracle.model.services.AgendaService;
import br.gov.df.economia.sistemaauditoriahiveoracle.model.services.SchedulerManager;
...
public class MainViewController implements Initializable {
    ...
    public void onMenuItemHivedivergencia9900TabelasSpedAction() {
        ...
        String nomeArquivo =  Configuracao.DIRECTORY_PATH_PENDENCIA_SPED + "divergencia9900TabelasSped.csv";
    ...
    public void onMenuItemPendencia9900OracleTabelasHiveAction() {
        ...
        String inputFilePath = Configuracao.DIRECTORY_PATH_PENDENCIA_SPED + "ORACLE_SPED_9900.csv";
        String outputFilePath9900OracleTabelasHive = Configuracao.DIRECTORY_PATH_PENDENCIA_SPED + "ResultadoQuery.csv";
    ...
    public void onMenuItemPendenciaProcessamento0000() {
        ...
        String outputFilePath = Configuracao.DIRECTORY_PATH_PENDENCIA_SPED + "Pendencia_Processamento_0000.csv";
    ...
    public void onMenuProcessarPendenciaAction() {
        ...
        handleRemoveOracleHive();
        CSVUtils.deleteFilesExceptPendencia( Configuracao.DIRECTORY_PATH_PENDENCIA_HIVE );
