...
public class OracleDecDatabaseOperations {
    ...
    public void executeQueryAndSaveToCSV() {
        ...
        try (Connection connection = DriverManager.getConnection(jdbcURL, username, password)) {
            ...
            String filePath1 = Configuracao.DIRECTORY_PATH_PENDENCIA_HIVE + "gGrContratArquivos.csv";
            ...
            String query2 = "SELECT /*+first_rows(100) parallel(8) */ " +
                    ...
                    "GROUP BY TO_CHAR(f.dhproc, 'YYYYMMDD')";
            String filePath2 =  Configuracao.DIRECTORY_PATH_PENDENCIA_HIVE + "gGrandFatArquivos.csv";
